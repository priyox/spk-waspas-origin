                            ...
                            <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                        ...
                                        <div class="mt-4">
                                            <div class="mb-4">
                                                <label for="bidang" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama Bidang Ilmu</label>
                                                <input type="text" wire:model="bidang" id="bidang" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm">
