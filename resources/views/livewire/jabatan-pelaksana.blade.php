        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Jabatan Pelaksana</h2>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Kelola data jabatan pelaksana</p>
                    </div>
                ...
                <div class="mb-8 relative max-w-md">
                    ...
                    <input wire:model.live.debounce.300ms="search" type="text" placeholder="Cari Jabatan Pelaksana..." 
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse($jabatanPelaksanas as $index => $jabatan)
                            ...
                            <tr>
                                <td colspan="3" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                    Tidak ada data jabatan pelaksana
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
                ...
                <div class="mt-4">
                    {{ $jabatanPelaksanas->links() }}
                </div>

                <x-modal name="jabatan-pelaksana-modal" :show="$isModalOpen" maxWidth="lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <h3 class="text-lg leading-6 font-medium mb-4">
                            {{ $jabatan_id_to_edit ? 'Edit Jabatan Pelaksana' : 'Tambah Jabatan Pelaksana' }}
                        </h3>
