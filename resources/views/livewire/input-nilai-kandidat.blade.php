                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                <th scope="col" class="px-6 py-4 text-center text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-widest border-b border-gray-200 dark:border-gray-600 sticky left-0 bg-gray-100 dark:bg-gray-700 z-10 w-64">
                                    Nama Kandidat
                                </th>
                                    ...
                                    @if($kandidat->isDinilai())
                                        <div class="flex flex-col gap-2">
                                            <button wire:click="startEditing('{{ $kandidat->id }}')" 
                                                class="inline-flex items-center justify-center px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white text-sm font-medium rounded-lg transition-colors shadow-sm">
                                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                </svg>
                                                Edit Nilai
                                            </button>
                                            <button wire:click="confirmReset('{{ $kandidat->id }}')" 
                    ...
                    <x-modal name="delete-confirmation" :show="$isDeleteModalOpen" maxWidth="sm">
                        <div class="p-6">
                            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                                Konfirmasi Reset Nilai
                            </h2>
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Apakah Anda yakin ingin mereset nilai untuk kandidat <strong>{{ $kandidatNameToDelete }}</strong>? Nilai yang sudah diinput akan dihapus.
                            </p>
                            <div class="mt-6 flex justify-end">
                                <button wire:click="closeDeleteModal" class="ml-3 inline-flex justify-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Batal
                                </button>
                                <button wire:click="resetNilai" class="ml-3 inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                    Reset Nilai
                                </button>
                            </div>
                        </div>
