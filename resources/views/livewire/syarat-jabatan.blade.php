        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
            ...
            <form wire:submit.prevent="store">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {{-- Syarat Golongan --}}
                    <div>
                        <label for="syarat_golongan_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                            Syarat Golongan <span class="text-red-500">*</span>
                        </label>
                        <select id="syarat_golongan_id" wire:model="syarat_golongan_id"
                            class="w-full px-3 py-2.5 border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 rounded-lg shadow-sm">
                            <option value="">-- Pilih Golongan --</option>
                            @foreach($golongans as $golongan)
                                <option value="{{ $golongan->id }}">{{ $golongan->golongan }}</option>
                        ...
                        @error('syarat_golongan_id') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                    </div>
